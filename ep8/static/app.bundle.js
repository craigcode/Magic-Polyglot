    ...
    if (kanbanColumn) {
        sortable_esm.create(kanbanColumn, {
            ...
            onEnd: function (/**Event*/evt) {
                ...
                if(evt.from.id != evt.to.id || evt.oldIndex != evt.newIndex){
                    ...
                    CardMove(itemEl.id, evt.from.id, evt.oldIndex, evt.to.id, evt.newIndex);
                }
            },
        });
    }
